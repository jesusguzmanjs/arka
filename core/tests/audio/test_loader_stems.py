"""Tests for the v2.0 stem-extraction addition to ``cuegrid.audio.loader``.
...
import ffmpeg
import pytest
from cuegrid.audio.loader import DRUMS_STEM_STREAM_INDEX, extract_drum_stem


class TestExtractDrumStem:
    def test_invokes_ffmpeg_with_expected_stream_map(self):
        with patch("cuegrid.audio.loader.ffmpeg") as mock_ffmpeg:
