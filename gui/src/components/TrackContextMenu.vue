...
<template>
  ...
  >
    ...
    <button
        type="button"
        class="whitespace-nowrap rounded-sm px-2.5 py-1.5 text-left text-xs text-zinc-200 transition-colors hover:bg-zinc-800 hover:text-primary focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary"
        role="menuitem"
        @click="emit('action')"
    >
      {{ actionLabel }}
